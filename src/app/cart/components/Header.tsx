...
const Header = () => {
  ...
  return (
    <header className="bg-orange-500">
      ...
      <nav className=" bg-white text-orange-500 text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center">
              <img alt="Tailwind" src="https://tailwindui.com/img/logos/mark.svg?color=black" className="h-8 w-auto" />
              <span className="ml-2 text-2xl font-bold border-r border-orange-500 px-4">Tailwind</span>
              <span className="text-lg px-4 font-medium">Keranjang Belanja</span>
            </Link>
          </div>
        </div>
      </nav>
